...
namespace es
{
    ...
    {
    public:
        std::unordered_map<area::ActionType, std::function<Action*(Reaction *, const size_t &, const json &)>>
        ...
        std::unordered_map<area::ReactionType, std::function<Reaction*(const size_t &, const json &)>>
